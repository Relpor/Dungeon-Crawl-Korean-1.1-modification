...
#ifdef JP
    bool        use_zenkaku;    //¿¸∞¢ ªÁøÎ ø©∫Œ
#endif

#ifdef USE_TILE
    bool        use_tile;       //É^ÉCÉãÇégópÇ∑ÇÈÇ©î€Ç©
    bool        use_qv_mode;    //ÉNÉIÅ[É^Å[ÉrÉÖÅ[ÇégópÇ∑ÇÈÇ©î€Ç©
    bool        rotate_numpad;
    bool        rotate_minimap;
...
#if 1 //JP
    bool        use_cake;       //ÉgÉEÉtÇégópÇ∑ÇÈÇ©î€Ç©
#endif //JP
    bool        stress_cursed;  //éÙÇÌÇÍÇΩÉAÉCÉeÉÄÇê‘ï∂éöï\é¶Ç∑ÇÈÇ©î€Ç©
    // internal use only:
