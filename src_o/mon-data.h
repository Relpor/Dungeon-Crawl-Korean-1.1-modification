...
#ifdef JP
{
    MONS_PROGRAM_BUG, 'B', LIGHTRED, "«¡∑Œ±◊∑• πˆ±◊",
    M_NO_EXP_GAIN,
...
{
    MONS_GIANT_ANT, 'a', DARKGREY, "∞≈¥Î ∞≥πÃ",
    M_ED_POISON,
...
{
    MONS_FUNGUS, 'f', LIGHTGREY, "µµ±˙∫Ò πˆº∏",
...
{
    MONS_KILLER_BEE_LARVA, 'w', LIGHTGREY, "≈≥∑Ø∫Ò ¿Ø√Ê",
...
{
    MONS_NECROPHAGE, 'n', DARKGREY, "Ω√√º ∆˜Ωƒ¿⁄",
...
// ñÛÅFÉgÉìÉlÉãÉèÅ[ÉÄÇÕé¿ëïÇ™ÉAÉåÇæÇ¡ÇΩÇÃÇ≈è¡ÇµÇ‹ÇµÇΩÅB
{
    MONS_TUNNELING_WORM, 't', LIGHTRED, "µø±º π˙∑π",
    M_RES_POISON,
...
{
    MONS_FIRE_VORTEX, 'v', RED, "»≠ø∞¿« º“øÎµπ¿Ã",
...
// random
{
    MONS_ABOMINATION_SMALL, 'x', BLACK, "æÓ∫∏πÃ≥◊¿Ãº«",
    M_NO_FLAGS,
...
{
    MONS_GIANT_BEETLE, 'B', DARKGREY, "∞≈¥Î«— ≈ı±∏π˙∑π",
    M_ED_POISON,
...
{
    MONS_TWO_HEADED_OGRE, 'O', LIGHTRED, "Ω÷µŒ ø¿øÏ∞≈",
    M_WARM_BLOOD,
...
{
    MONS_FIEND, '1', LIGHTRED, "«…µÂ", //jmf: was RED, like Balrog
...
{
    MONS_ICE_BEAST, 'I', WHITE, "æÛ¿Ω æﬂºˆ",
...
{
    MONS_GUARDIAN_NAGA, 'N', LIGHTGREEN, "≥™∞° ºˆ»£¿⁄",
...
{
    MONS_UNSEEN_HORROR, 'x', MAGENTA, "∫∏¿Ã¡ˆ æ ¥¬ µŒ∑¡øÚ",
...
{
    MONS_ABOMINATION_LARGE, 'X', BLACK, "æÓ∫∏πÃ≥◊¿Ãº«",
    M_NO_FLAGS,
...
{
    MONS_ORC_WARRIOR, 'o', YELLOW, "ø¿≈© ¿¸ªÁ",
    M_WARM_BLOOD,
...
{
    MONS_KOBOLD_DEMONOLOGIST, 'K', MAGENTA, "ƒ⁄∫º∆Æ æ«∏∂º˙ªÁ",
...
{
    MONS_ORC_WIZARD, 'o', MAGENTA, "ø¿≈© ∏∂π˝ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
...
{
    MONS_ORC_KNIGHT, 'o', LIGHTCYAN, "ø¿≈© ±‚ªÁ",
    M_WARM_BLOOD,
    0, 10, MONS_ORC, MH_NATURAL, -3,
    { 25, 0, 0, 0 },
    { 9, 4, 7, 0 },
...
// not until it can be reimplemented safely {dlb}
{
    MONS_WORM_TAIL, '~', LIGHTRED, "π˙∑π ≤ø∏Æ",
    M_NO_EXP_GAIN | M_RES_POISON,
...
{
    MONS_GIANT_EYEBALL, 'G', WHITE, "∞≈¥Î«— ¥´æÀ",
...
{
    MONS_HUNGRY_GHOST, 'p', GREEN, "πË∞Ì«¬ ¿Ø∑…",
...
{
    MONS_EYE_OF_DRAINING, 'G', LIGHTGREY, "»Ìº∫ ¥´æÀ",
...
{
    MONS_WANDERING_MUSHROOM, 'f', BROWN, "πÊ»≤«œ¥¬ πˆº∏",
    M_RES_POISON,
...
{
    MONS_BRAIN_WORM, 'w', LIGHTMAGENTA, "≥˙ºˆ π˙∑π",
    M_SPELLCASTER,
...
{
    MONS_GIANT_ORANGE_BRAIN, 'G', LIGHTRED, "∞≈¥Î«— ø¿∑ª¡ˆªˆ ≥˙",
...
{
    MONS_BOULDER_BEETLE, 'B', LIGHTGREY, "æœºÆ ≈ı±∏π˙∑π",
    M_ED_POISON,
...
{
    MONS_FLYING_SKULL, 'z', WHITE, "≥Øæ∆¥Ÿ¥œ¥¬ «ÿ∞Ò",
...
{
    MONS_HELL_HOUND, 'h', DARKGREY, "«Ô«œøÓµÂ",
...
{
    MONS_MINOTAUR, 'm', LIGHTRED, "πÃ≥Î≈∏øÏ∏£Ω∫",
    M_WARM_BLOOD,
...
{
    MONS_ICE_DRAGON, 'D', WHITE, "æÛ¿Ω øÎ",
...
{
    MONS_SLIME_CREATURE, 'J', GREEN, "ΩΩ∂Û¿”",
...
{
    MONS_FREEZING_WRAITH, 'W', LIGHTBLUE, "≥√±‚¿« ∑π¿ÃΩ∫",
...
{
    MONS_RAKSHASA_FAKE, 'R', YELLOW, "∂Ùª˛ª˛",
    M_RES_POISON,
...
{
    MONS_GREAT_ORB_OF_EYES, 'G', LIGHTGREEN, "¥Î«¸ ¥´æÀ ±∏√º",
...
{
    MONS_ROTTING_DEVIL, '4', GREEN, "∫Œ∆–¿« æ«∏∂",
    M_RES_POISON | M_RES_COLD,
...
{
    MONS_SOUL_EATER, '2', DARKGREY, "øµ»•¿ª ∏‘¥¬ æ«∏∂",
    M_RES_POISON | M_RES_COLD | M_LEVITATE | M_SEE_INVIS,
...
{
    MONS_HAIRY_DEVIL, '4', LIGHTRED, "¥˛ºˆ∑Ë«— æ«∏∂",
    M_RES_POISON,
...
{
    MONS_GLOWING_SHAPESHIFTER, '@', RED, "πﬂ±§«œ¥¬ ∫Ø«¸±´π∞",
    M_NO_FLAGS,
...
{
    MONS_SHAPESHIFTER, '@', LIGHTRED, "∫Ø«¸±´π∞",
    M_NO_FLAGS,
    600, 10, MONS_SHAPESHIFTER, MH_NATURAL, -6,
    { 5, 0, 0, 0 },
    { 7, 3, 5, 0 },
...
{
    MONS_GIANT_MITE, 's', LIGHTRED, "∞≈¥Î«— ¡¯µÂ±‚",
    M_ED_POISON,
...
{
    MONS_STEAM_DRAGON, 'd', LIGHTGREY, "¡ı±‚ øÎ",
...
{
    MONS_VERY_UGLY_THING, 'u', RED, "æ∆¡÷ ∏¯ª˝±‰ ∞Õ",
    M_WARM_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_ORC_SORCERER, 'o', DARKGREY, "ø¿≈© ∏∂π˝ªÁ",
...
// small skeleton
{
    MONS_SKELETON_SMALL, 'z', LIGHTGREY, "«ÿ∞Ò",
    M_RES_POISON | M_RES_COLD,
...
// large skeleton
{
    MONS_SKELETON_LARGE, 'Z', LIGHTGREY, "«ÿ∞Ò",
    M_RES_POISON | M_RES_COLD,
...
{
    MONS_NECROMANCER, '@', DARKGREY, "∞≠∑…º˙ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
...
{
    MONS_ORC_PRIEST, 'o', LIGHTGREEN, "ø¿≈© ªÁ¡¶",
...
{
    MONS_ORC_HIGH_PRIEST, 'o', GREEN, "ªÛ±ﬁ ø¿≈© ªÁ¡¶",
...
{
    MONS_WOOD_GOLEM, '8', YELLOW, "≥™π´ ∞Ò∑Ω",
...
{
    MONS_STONE_GOLEM, '8', LIGHTGREY, "πŸ¿ß ∞Ò∑Ω",
...
{
    MONS_CRYSTAL_GOLEM, '8', WHITE, "ºˆ¡§ ∞Ò∑Ω",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC | M_SEE_INVIS,
...
{
    MONS_TOENAIL_GOLEM, '8', LIGHTGREY, "º’≈È ∞Ò∑Ω",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC,
...
{
    MONS_MOTTLED_DRAGON, 'd', LIGHTMAGENTA, "æÛ∑Ëπ´¥Ã øÎ",
...
{
    MONS_EARTH_ELEMENTAL, '#', BROWN, "¥Î¡ˆ¿« ¡§∑…",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC,
...
{
    MONS_AIR_ELEMENTAL, 'v', LIGHTGREY, "¥Î±‚¿« ¡§∑…",
...
{
    MONS_ICE_FIEND, '1', WHITE, "æ∆¿ÃΩ∫ «…µÂ",
...
{
    MONS_SHADOW_FIEND, '1', DARKGREY, "Ω¶µµøÏ «…µÂ",
...
{
    MONS_BROWN_SNAKE, 'S', BROWN, "∞•ªˆ πÏ",
...
{
    MONS_GIANT_LIZARD, 'l', GREEN, "∞≈¥Î«— µµ∏∂πÏ",
    M_COLD_BLOOD,
...
{
    MONS_SPECTRAL_WARRIOR, 'W', LIGHTGREEN, "¿Ø∑… ¿¸ªÁ",
    M_RES_POISON | M_RES_COLD | M_LEVITATE | M_SEE_INVIS,
...
{
    MONS_PULSATING_LUMP, 'J', RED, "π⁄µø«œ¥¬ µ¢æÓ∏Æ",
...
{
    MONS_STORM_DRAGON, 'D', LIGHTBLUE, "∆¯«≥ øÎ",
...
{
    MONS_YAKTAUR, 'c', LIGHTRED, "æﬂ≈©≈∏øÏæÓ",
    M_WARM_BLOOD,
...
{
    MONS_DEATH_YAK, 'Y', DARKGREY, "¡◊¿Ω¿« æﬂ≈©",
    M_WARM_BLOOD,
...
{
    MONS_ROCK_TROLL, 'T', LIGHTGREY, "πŸ¿ß ∆Æ∑—",
    M_WARM_BLOOD,
...
{
    MONS_STONE_GIANT, 'C', LIGHTGREY, "πŸ¿ß ∞≈¿Œ",
    M_WARM_BLOOD,
...
{
    MONS_FLAYED_GHOST, 'p', RED, "»Â∆Æ∑Ø¡¯ ¿Ø∑…",
...
{
    MONS_REDBACK, 's', RED, "∫”¿∫ µÓ ∞≈πÃ",  //ÉZÉAÉJÉSÉPÉOÉÇ
    M_ED_POISON,
...
{
    MONS_INSUBSTANTIAL_WISP, 'p', LIGHTGREY, "»ÒπÃ«— ¿ßΩ¿",
...
{
    MONS_OGRE_MAGE, 'O', MAGENTA, "ø¿øÏ∞≈ ∏∂º˙ªÁ",
...
{
    MONS_SPINY_WORM, 'w', DARKGREY, "∞°Ω√ π˙∑π",
    M_ED_POISON,
...
{
    MONS_GOLDEN_DRAGON, 'D', YELLOW, "»≤±› øÎ",
...
{
    MONS_LINDWURM, 'd', LIGHTGREEN, "∏∞µÂ∫Í∑Î",
    M_NO_FLAGS,
...
{
    MONS_ELEPHANT_SLUG, 'm', LIGHTGREY, "ƒ⁄≥¢∏Æ ΩΩ∑Ø±◊",
    M_ED_POISON | M_NO_SKELETON,
...
{
    MONS_GREEN_RAT, 'r', LIGHTGREEN, "√ ∑œªˆ ¡„",
    M_WARM_BLOOD,
...
{
    MONS_ORANGE_RAT, 'r', LIGHTRED, "ø¿∑ª¡ˆªˆ ¡„",
    M_WARM_BLOOD,
...
{
    MONS_BLACK_SNAKE, 'S', DARKGREY, "∞À¿∫ πÏ",
...
{
    MONS_GIANT_MOSQUITO, 'y', DARKGREY, "∞≈¥Î«— ∏±‚",
    M_ED_POISON | M_FLIES,
...
{
    MONS_GIANT_CENTIPEDE, 's', GREEN, "∞≈¥Î«— ¡ˆ≥◊",
    M_ED_POISON,
...
{
    MONS_FROST_GIANT, 'C', LIGHTBLUE, "≥√±‚ ∞≈¿Œ",
...
{
    MONS_FIREDRAKE, 'd', RED, "∆ƒ¿ÃæÓ µÂ∑π¿Ã≈©",
    M_RES_FIRE | M_FLIES,
...
{
    MONS_SHADOW_DRAGON, 'D', DARKGREY, "±◊∏≤¿⁄ øÎ",
...
,
{
    MONS_YELLOW_SNAKE, 'S', YELLOW, "≥Î∂ıªˆ πÏ",
    M_RES_POISON | M_COLD_BLOOD,
...
{
    MONS_GREY_SNAKE, 'S', LIGHTGREY, "»∏ªˆ πÏ",
    M_COLD_BLOOD,
...
{
    MONS_DEEP_TROLL, 'T', DARKGREY, "µø±º ∆Æ∑—",
...
{
    MONS_GIANT_BLOWFLY, 'y', LIGHTGREY, "∞≈¥Î«— ∆ƒ∏Æ",
    M_ED_POISON | M_FLIES,
...
{
    MONS_SWAMP_DRAGON, 'D', BROWN, "¥À¡ˆ øÎ",
...
{
    MONS_SWAMP_DRAKE, 'd', BROWN, "¥À¡ˆ µÂ∑π¿Ã≈©",
    M_SPELLCASTER | M_FLIES | M_RES_POISON,
...
{
    MONS_SOLDIER_ANT, 'a', LIGHTGREY, "∫¥¡§ ∞≥πÃ",
    M_ED_POISON,
...
{
    MONS_HILL_GIANT, 'C', LIGHTRED, "ªÍæ« ∞≈¿Œ",
    M_WARM_BLOOD,
...
{
    MONS_QUEEN_ANT, 'Q', DARKGREY, "ø©ø’ ∞≥πÃ",
    M_ED_POISON,
...
{
    MONS_ANT_LARVA, 'w', LIGHTGREY, "∞≥πÃ ¿Ø√Ê",
    M_ED_POISON | M_NO_SKELETON,
...
{
    MONS_GIANT_BROWN_FROG, 'F', BROWN, "∞≈¥Î«— ∞•ªˆ ∞≥±∏∏Æ",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_SPINY_FROG, 'F', YELLOW, "∞°Ω√≈ıº∫¿Ã ∞≥±∏∏Æ",
...
{
    MONS_BLINK_FROG, 'F', LIGHTGREEN, "±Ù∫˝∞≈∏Æ¥¬ ∞≥±∏∏Æ",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
,
{
    MONS_GIANT_COCKROACH, 'a', BROWN, "∞≈¥Î«— πŸƒ˚π˙∑π",
    M_NO_FLAGS,
...
,
{
    MONS_SMALL_SNAKE, 'S', LIGHTGREEN, "¿€¿∫ πÏ",
    M_COLD_BLOOD,
...
{
    MONS_UFETUBUS, '5', LIGHTCYAN, "øÏ∆‰≈ÕπˆΩ∫",
...
{
    MONS_ORANGE_DEMON, '3', LIGHTRED, "ø¿∑ª¡ˆªˆ æ«∏∂",
    M_NO_FLAGS,
...
{
    MONS_SMOKE_DEMON, '4', LIGHTGREY, "ø¨±‚¿« æ«∏∂",
    M_RES_POISON | M_RES_FIRE | M_SPELLCASTER | M_FLIES,
...
{
    MONS_EXECUTIONER, '1', LIGHTGREY, "√≥«¸¿« æ«∏∂",
...
{
    MONS_GREEN_DEATH, '1', GREEN, "√ ∑œ¿« º∂∏Í¿⁄",
    M_RES_POISON | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_DEMONIC_CRAWLER, '3', DARKGREY, "¡ˆ≥◊¿« æ«∏∂",
...
{
    MONS_SHADOW_DEMON, '3', DARKGREY, "±◊∏≤¿⁄¿« æ«∏∂",
...
{
    MONS_SHADOW_WRAITH, 'W', BLUE, "±◊∏≤¿⁄¿« ∑π¿ÃΩ∫",
...
{
    MONS_GIANT_AMOEBA, 'J', BLUE, "∞≈¥Î«— æ∆∏ﬁπŸ",
...
{
    MONS_GIANT_SLUG, 'm', GREEN, "∞≈¥Î«— ΩΩ∑Ø±◊",
...
{
    MONS_GIANT_SNAIL, 'm', LIGHTGREEN, "∞≈¥Î«— ¥ﬁ∆ÿ¿Ã",
    M_NO_SKELETON | M_AMPHIBIOUS,
...
{
    MONS_SPATIAL_VORTEX, 'v', BLACK, "Ω√∞¯¿« º“øÎµπ¿Ã",
...
{
    MONS_BORING_BEETLE, 'B', BROWN, "√µ∞¯ ≈ı±∏π˙∑π",
    M_ED_POISON,
...
{
    MONS_METAL_GARGOYLE, 'g', CYAN, "±›º” ∞°∞Ì¿œ",
    M_RES_POISON | M_RES_ELEC | M_FLIES,
...
{
    MONS_MOLTEN_GARGOYLE, 'g', RED, "øÎæœ¿« ∞°∞Ì¿œ",
...
{
    MONS_GLOORX_VLOQ, '&', DARKGREY, "±◊∑ÍΩ∫-∫Í∑œ≈©",
...
{
    MONS_NAGA_MAGE, 'N', LIGHTRED, "≥™∞° ∏∂º˙ªÁ",
...
{
    MONS_ORC_WARLORD, 'o', LIGHTGREY, "ø¿≈© øˆ∑ŒµÂ",
    M_WARM_BLOOD,
...
{
    MONS_DEEP_ELF_SOLDIER, 'e', CYAN, "µˆ ø§«¡ ∫¥ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
...
{
    MONS_DEEP_ELF_FIGHTER, 'e', LIGHTBLUE, "µˆ ø§«¡ ¿¸ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 6, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_KNIGHT, 'e', BLUE, "µˆ ø§«¡ ±‚ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 14, 0, 0, 0 },
    { 11, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_MAGE, 'e', LIGHTRED, "µˆ ø§«¡ ∏∂º˙ªÁ",
...
{
    MONS_DEEP_ELF_SUMMONER, 'e', YELLOW, "µˆ ø§«¡ º“»Øº˙ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 5, 0, 0, 0 },
    { 6, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_CONJURER, 'e', LIGHTGREEN, "µˆ ø§«¡ ø‰º˙ªÁ",
...
{
    MONS_DEEP_ELF_PRIEST, 'e', LIGHTGREY, "µˆ ø§«¡ ªÁ¡¶",
    M_SPELLCASTER | M_PRIEST | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 5, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_HIGH_PRIEST, 'e', DARKGREY, "µˆ ø§«¡ ªÛ±ﬁ ªÁ¡¶",
...
{
    MONS_DEEP_ELF_DEMONOLOGIST, 'e', MAGENTA, "µˆ ø§«¡ æ«∏∂º˙ªÁ",
...
{
    MONS_DEEP_ELF_ANNIHILATOR, 'e', GREEN, "µˆ ø§«¡ ∆ƒ±´º˙ªÁ",
...
{
    MONS_DEEP_ELF_SORCERER, 'e', RED, "µˆ ø§«¡ º“º≠∑Ø",
...
{
    MONS_DEEP_ELF_DEATH_MAGE, 'e', WHITE, "µˆ ø§«¡ ¡◊¿Ω ∏∂º˙ªÁ",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SEE_INVIS,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 12, 0, 0, 0 },
    { 15, 3, 3, 0 },
...
{
    MONS_BROWN_OOZE, 'J', BROWN, "∞•ªˆ ¡¯»Î±´π∞",
...
{
    MONS_AZURE_JELLY, 'J', LIGHTBLUE, "¥„√ªªˆ ¡©∏Æ",
...
{
    MONS_DEATH_OOZE, 'J', DARKGREY, "¡◊¿Ω¿« ¡©∏Æ",
...
{
    MONS_ACID_BLOB, 'J', LIGHTGREEN, "ªÍº∫ µ¢¿Ã",
    M_RES_POISON | M_NO_SKELETON | M_SEE_INVIS,
...
{
    MONS_ROYAL_JELLY, 'J', YELLOW, "∑Œæ‚ ¡©∏Æ",
    M_RES_POISON | M_NO_SKELETON | M_SEE_INVIS,
...
{
    MONS_BLORK_THE_ORC, 'o', BROWN, "ø¿≈© ∫Ì∑Œ≈©",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS | M_WARM_BLOOD,
...

{
    ...
    MONUSE_WEAPONS_ARMOUR
}//ÉtÉâÉìÉZÉXÇ∆Ç∑ÇÈÇ±Ç∆Ç≈FRANCESÇ∆ãÊï 
,

{
    MONS_FRANCES, '@', YELLOW, "«¡∂ıΩ√Ω∫",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    0, 20, MONS_HUMAN, MH_NATURAL, -5,
    { 11, 0, 0, 0 },
    { 14, 0, 0, 70 },
...
{
    MONS_ASMODEUS, '&', LIGHTMAGENTA, "æ∆Ω∫∏µ•øÏΩ∫",
...
{
    MONS_ANTAEUS, 'C', LIGHTCYAN, "æÿ≈Õ¿ÃøÏΩ∫",
...
{
    MONS_ANCIENT_LICH, 'L', DARKGREY, "∞Ì¥Î¿« ∏Æƒ°",
...
/* These nasties are never randomly generated, only sometimes specially
   placed in the Crypt. */
{
    MONS_CURSE_SKULL, 'z', DARKGREY, "¿˙¡÷πﬁ¿∫ «ÿ∞Ò",
...
{
    MONS_VAMPIRE_KNIGHT, 'V', CYAN, "πÏ∆ƒ¿ÃæÓ ±‚ªÁ",
    M_RES_POISON | M_RES_COLD | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_VAMPIRE_MAGE, 'V', MAGENTA, "πÏ∆ƒ¿ÃæÓ ∏∂º˙ªÁ",
...
{
    MONS_SHINING_EYE, 'G', LIGHTMAGENTA, "∫˚≥™¥¬ ¥´",
...
{
    MONS_ORB_GUARDIAN, 'X', MAGENTA, "ø¿∫Í ºˆ»£¿⁄",
...
{
    MONS_SPECTRAL_THING, 'W', GREEN, "¿Ø∑… ∞∞¿∫ ∞Õ",
    M_RES_POISON | M_RES_COLD | M_LEVITATE | M_SEE_INVIS,
...
{
    MONS_SKELETAL_DRAGON, 'D', LIGHTGREY, "«ÿ∞Ò øÎ",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC | M_SEE_INVIS,
...
{
    MONS_TENTACLED_MONSTROSITY, 'X', GREEN, "√Àºˆ ±´π∞",
...
{
    MONS_ROTTING_HULK, 'n', BROWN, "π›¬Î Ω‚¿∫ ∞≈¿Œ",
    M_RES_POISON | M_RES_COLD,
...
{
    MONS_GUARDIAN_MUMMY, 'M', YELLOW, "πÃ∂Û ºˆ»£¿⁄",
    M_RES_POISON | M_RES_COLD | M_SEE_INVIS,
...
{
    MONS_GREATER_MUMMY, 'M', DARKGREY, "∞Ì¥Î¿« πÃ∂Û",
    M_RES_POISON | M_RES_COLD | M_RES_ELEC | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS,
...
{
    MONS_MUMMY_PRIEST, 'M', RED, "πÃ∂Û ªÁ¡¶",
...
{
    MONS_CENTAUR_WARRIOR, 'c', YELLOW, "ºæ≈∏øÏ∏£ ¿¸ªÁ",
    M_WARM_BLOOD,
...
{
    MONS_YAKTAUR_CAPTAIN, 'c', RED, "æﬂ≈©≈∏øÏæÓ ƒ∏∆æ",
    M_WARM_BLOOD,
    2000, 10, MONS_YAKTAUR, MH_NATURAL, -3,
    { 23, 0, 0, 0 },
    { 14, 3, 5, 0 },
...
{
    MONS_KILLER_KLOWN, '@', BLACK, "ªÏ¿Œ¿⁄ ««ø°∑Œ",
...
{
    MONS_ELECTRIC_GOLEM, '8', LIGHTCYAN, "¿¸±‚¿« ∞Ò∑Ω",
...
{
    MONS_BALL_LIGHTNING, '*', LIGHTCYAN, "π¯∞≥¿« ±∏",
...
{
    MONS_EYE_OF_DEVASTATION, 'G', YELLOW, "∆ƒ±´¿« ¥´",
    M_NO_SKELETON | M_LEVITATE | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_MOTH_OF_WRATH, 'y', BROWN, "¡¯≥Î¿« ≥™πÊ",
    M_FLIES,
...
{
    MONS_DEATH_COB, '%', YELLOW, "ªÏ¿Œ ø¡ºˆºˆ",
...
{
    MONS_CURSE_TOE, 'z', DARKGREY, "¿˙¡÷¿« πﬂ∞°∂Ù", 
    M_RES_ELEC | M_RES_POISON | M_RES_HELLFIRE | M_RES_COLD | M_LEVITATE | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_SCROLL_MIMIC, '?', LIGHTGREY, "πÃπÕ",
    M_NO_SKELETON | M_RES_POISON | M_RES_ELEC | M_RES_FIRE | M_RES_COLD,
    0, 13, MONS_GOLD_MIMIC, MH_NONLIVING, -3,
    { 12, 12, 12, 0 },
    { 8, 3, 5, 0 },
...
{
    MONS_SERPENT_OF_HELL, 'D', RED, "¡ˆø¡¿« µ∂ªÁ",
...
{
    MONS_QUICKSILVER_DRAGON, 'D', LIGHTCYAN, "ºˆ¿∫¿« øÎ",
...
{
    MONS_SKELETAL_WARRIOR, 'z', CYAN, "«ÿ∞Ò ¿¸ªÁ",
...
{
    MONS_PLAYER_GHOST, 'p', DARKGREY, "¿Ø∑…",
...
{
    MONS_PANDEMONIUM_DEMON, '&', BLACK, "∆«µ•∏¥œøÚ¿« æ«∏∂",
...
{  // mv: was another lava thing
    MONS_SALAMANDER, 'S', LIGHTRED, "ª¯∑Ø∏«¥ı",
...
{
    MONS_BIG_FISH, ';', LIGHTGREEN, "∞≈¥Î«— π∞∞Ì±‚",
    M_COLD_BLOOD,
...
{
    MONS_GIANT_GOLDFISH, ';', LIGHTRED, "∞≈¥Î«— ±›∫ÿæÓ",
    M_COLD_BLOOD,
...
{
    MONS_ELECTRICAL_EEL, ';', LIGHTBLUE, "¿¸±‚ πÏ¿ÂæÓ",
...
{
    MONS_WATER_ELEMENTAL, '{', LIGHTBLUE, "π∞¿« ¡§∑…",
...
{
    MONS_SWAMP_WORM, 'w', BROWN, "¥À¡ˆ π˙∑π",
    M_AMPHIBIOUS,
...
#if 0 
{
    MONS_SHUGGOTH, 'A', LIGHTGREEN, "º≈∞ÌΩ∫",
...
{
    MONS_GRIZZLY_BEAR, 'U', LIGHTGREY, "±◊∏Æ¡Ò∏Æ ∞ı",
    M_WARM_BLOOD,
...
{
    MONS_BLACK_BEAR, 'U', DARKGREY, "»Ê∞ı",
    M_WARM_BLOOD,
...
{
    MONS_GIANT_NEWT, 'l', LIGHTGREEN, "¥∫∆Æ",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_KOMODO_DRAGON, 'l', BROWN, "ƒ⁄∏µµ øÎ",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_ORC_WARLORD, 'o', LIGHTGREY, "orc warlord",
    M_WARM_BLOOD,
    600, 15, MONS_ORC, MH_NATURAL, -3,
    { 32, 0, 0, 0 },
    { 15, 4, 7, 0 },
